...
public class FriendCircle {
    public static void main(String[] args) {
        ...
        assert true == Arrays.equals(
                new String[] {"friend3", "friend4", "friend5"}, new FriendCircle().findLargestFriendCircle(new String[][]{
                        {"friend1", "friend2"},
                        {"friend3", "friend4"},
                        {"friend4", "friend5"},
                }));
        ...
        assert true == Arrays.equals(
                new String[] {"friend1", "friend2"}, new FriendCircle().findLargestFriendCircle(new String[][]{
                        {"friend1", "friend2"},
                        {"friend3", "friend4"},
                }));
